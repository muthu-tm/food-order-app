...
import 'package:chipchop_buyer/db/models/order_chat_temp.dart';
import 'package:chipchop_buyer/screens/orders/ChatImageView.dart';
...
class OrderChatScreenState extends State<OrderChatScreen> {
  ...
  Widget buildListMessage() {
    return Container(
      child: StreamBuilder(
        stream: OrderChatTemplate().streamOrderChats(widget.orderUUID, _limit),
